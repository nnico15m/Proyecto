...
val p2=this.createJug("p2","p2",5,2,5,1990,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones2,pendientesC,comunidad,listaC,4)
...
val p4=this.createJug("p4","p4",11,7,5,1990,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones3,pendientesC,comunidad,listaC,9)
...
val p8=this.createJug("p8","p8",9,5,5,1996,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones2,pendientesC,comunidad,listaC,3)
val p9=this.createJug("p9","p9",4,5,5,1996,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones,pendientesC,comunidad,listaC,7)
val p10=this.createJug("p10","p10",9,6,9,1994,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones2,pendientesC,comunidad,listaC,2)
val p11=this.createJug("p11","p11",6,2,4,1991,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones2,pendientesC,comunidad,listaC,1)
val p12=this.createJug("p12","p12",6,5,3,1942,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones4,pendientesC,comunidad,listaC,4)
val p13=this.createJug("p12","p12",6,5,3,1981,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones4,pendientesC,comunidad,listaC,4)
val jorge=this.createJug("jorge","george",11,7,5,1960,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones3,pendientesC,comunidad,listaC,9)
val manu=this.createJug("emanuel","manu",2,3,5,1990,amigosEpi,infraccionesEpi,5,formaDeInsc,"asd",mensajero,calificaciones4,pendientesC,comunidad,listaC,4)
