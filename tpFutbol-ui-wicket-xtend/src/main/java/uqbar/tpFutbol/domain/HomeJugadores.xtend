...
var calificacion12 = new Calificaciones(10,3,"descripcion")
var calificacion13 = new Calificaciones(11,1,"descripcion")
var calificaciones2 = new ArrayList
var calificaciones3 = new ArrayList
var calificaciones4 = new ArrayList
var calificaciones5 = new ArrayList
var calificaciones6 = new ArrayList
var calificaciones7 = new ArrayList
var calificaciones8 = new ArrayList
...
calificaciones5.add(calificacion9)
calificaciones5.add(calificacion10)
calificaciones5.add(calificacion11)
calificaciones5.add(calificacion12)
calificaciones6.add(calificacionX)
calificaciones6.add(calificacion6)
calificaciones6.add(calificacion10)
calificaciones6.add(calificacion13)	
calificaciones7.add(calificacion4)
calificaciones7.add(calificacion12)
calificaciones7.add(calificacion13)
calificaciones8.add(calificacion3)
calificaciones8.add(calificacion5)
calificaciones8.add(calificacionX)
	...
	val p4 =	this.createJug("p4","p4",11,7,5,fecha5,amigos3,infracciones1,5,formaDeInsc,"asd",mensajero,calificaciones5,pendientesC,comunidad,listaC,9)
	val p5 =	this.createJug("p5","p5",4,8,5,fecha6,amigos2,infracciones1,5,formaDeInsc,"asd",mensajero,calificaciones5,pendientesC,comunidad,listaC,8)	
	val p6 =	this.createJug("p6","p6",0,9,5,fecha7,amigos1,infracciones2,5,formaDeInsc,"asd",mensajero,calificaciones6,pendientesC,comunidad,listaC,5)
	val p7 =	this.createJug("p7","p7",2,3,5,fecha1,sinAmigos,infraccionesNulas,5,formaDeInsc,"asd",mensajero,calificaciones6,pendientesC,comunidad,listaC,4)
	...
	val p10 =	this.createJug("p10","p10",9,6,9,fecha2,amigos2,infracciones1,5,formaDeInsc,"asd",mensajero,calificaciones8,pendientesC,comunidad,listaC,2)
	val p11 =	this.createJug("p11","p11",6,2,4,fecha1,amigosEpi,infraccionesNulas,5,formaDeInsc,"asd",mensajero,calificaciones7,pendientesC,comunidad,listaC,1)
	...
	val jugadorSinInfracciones =	this.createJug("jugadorSinInfracciones","jugLimpio",2,3,5,fechaHoy,amigos2,infraccionesNulas,5,formaDeInsc,"asd",mensajero,calificaciones4,pendientesC,comunidad,listaC,4)
		...
		this.create("p4","p4",11,7,5,fecha5,amigos3,infracciones1,5,formaDeInsc,"asd",mensajero,calificaciones5,pendientesC,comunidad,listaC,9)
		this.create("p5","p5",4,8,5,fecha6,amigos2,infracciones1,5,formaDeInsc,"asd",mensajero,calificaciones5,pendientesC,comunidad,listaC,8)	
		this.create("p6","p6",0,9,5,fecha7,amigos1,infracciones2,5,formaDeInsc,"asd",mensajero,calificaciones6,pendientesC,comunidad,listaC,5)
		this.create("p7","p7",2,3,5,fecha1,sinAmigos,infraccionesNulas,5,formaDeInsc,"asd",mensajero,calificaciones6,pendientesC,comunidad,listaC,4)
		...
		this.create("p10","p10",9,6,9,fecha2,amigos2,infracciones1,5,formaDeInsc,"asd",mensajero,calificaciones8,pendientesC,comunidad,listaC,2)
		this.create("p11","p11",6,2,4,fecha1,amigosEpi,infraccionesNulas,5,formaDeInsc,"asd",mensajero,calificaciones7,pendientesC,comunidad,listaC,1)
